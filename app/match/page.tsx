  ...
  return (
    <main className="min-h-screen bg-[#020617] text-white">
      ...
      <section className="relative z-10 mx-auto max-w-6xl px-5 py-8">
        <PageHeader title="Match Center" subtitle="Crea partite, programma data e orario, invita giocatori e gestisci risultati da confermare." />
        <div className="grid gap-5 lg:grid-cols-3">
          <Panel icon={<Plus size={42} />} title="Crea partita" text="Sport, data, campo, partecipanti, squadra e slot liberi." button="Nuovo match" />
          <Panel icon={<CalendarDays size={42} />} title="Calendario" text="Vedi prossime partite, match in sospeso e risultati da confermare." button="Apri calendario" />
          <Panel icon={<ShieldCheck size={42} />} title="Conferme" text="Risultato proposto, conferma capitani/partecipanti e statistiche ufficiali." button="Match da validare" />
        </div>
      </section>
    </main>
  );
